...
public class AwsFlowEventDeserializer extends SpecificShapeDeserializer {

    private final Schema expectedMember;
    private final ShapeDeserializer memberDeserializer;

    public AwsFlowEventDeserializer(Schema expectedMember, ShapeDeserializer memberDeserializer) {

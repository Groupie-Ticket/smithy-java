...
public final class RequestDeserializer {
    ...
    /**
     * Event decoder for the request.
     *
     * @param eventDecoder A decoder for the event stream.
     * @return Returns the deserializer.
     */
    public RequestDeserializer eventDecoder(AwsFlowShapeDecoder<?> eventDecoder) {
        deserBuilder.eventDecoder(eventDecoder);
        return this;
    }

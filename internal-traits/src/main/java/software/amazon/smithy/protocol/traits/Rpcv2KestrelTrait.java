...
public final class Rpcv2KestrelTrait extends AbstractTrait implements ToSmithyBuilder<Rpcv2KestrelTrait> {

    public static final ShapeId ID = ShapeId.from("smithy.protocols#rpcv2Kestrel");
    ...
    private Rpcv2KestrelTrait(Builder builder) {
     ...
     */
    public static Rpcv2KestrelTrait fromNode(Node node) {
     ...
     */
    public static final class Builder extends AbstractTraitBuilder<Rpcv2KestrelTrait, Builder> {

        private final List<String> http = new ArrayList<>();
        private final List<String> eventStreamHttp = new ArrayList<>();

        @Override
        public Rpcv2KestrelTrait build() {
            return new Rpcv2KestrelTrait(this);
        }
    ...
    public static final class Provider extends AbstractTrait.Provider {
        ...
        public Trait createTrait(ShapeId target, Node value) {
            Rpcv2KestrelTrait result = fromNode(value);

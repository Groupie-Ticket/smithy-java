...
final class JsonIterSerializer implements ShapeSerializer {
    ...
    public void writeStruct(Schema schema, SerializableStruct struct) {
        try {
            ...
            struct.serializeMembers(new JsonIterStructSerializer(this, true));
    ...
    public <T> void writeMap(Schema schema, T mapState, BiConsumer<T, MapSerializer> consumer) {
        try {
            stream.writeObjectStart();
            consumer.accept(mapState, new JsonIterMapSerializer(this, stream));
            stream.writeObjectEnd();
        } catch (Exception e) {
            throw new SerializationException(e);
        }
            ...
            value.serializeContents(new SpecificShapeSerializer() {
                ...
                public void writeStruct(Schema schema, SerializableStruct struct) {
                    try {
                        ...
                        struct.serializeMembers(new JsonIterStructSerializer(JsonIterSerializer.this, false));
                        stream.writeObjectEnd();
                    } catch (Exception e) {
                        throw new SerializationException(e);
                    }

...
public final class KestrelDeserializer {
    private final byte[] b;
    private final int len;
    private int pos;

    public KestrelDeserializer(byte[] b) {
        this.b = b;
        this.len = b.length;
    }

    public KestrelDeserializer(byte[] b, int off, int len) {
        this.b = b;
        this.pos = off;
        this.len = len;
    }

    public KestrelDeserializer(ByteBuffer b) {
        if (b.hasArray()) {
            this.b = b.array();

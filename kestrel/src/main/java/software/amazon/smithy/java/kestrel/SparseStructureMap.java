...
import static software.amazon.smithy.java.kestrel.KConstants.encodeLenPrefixedListLength;
import static software.amazon.smithy.java.kestrel.KestrelSerializer.EMPTY_LIST_SIZE_VARINT;
import static software.amazon.smithy.java.kestrel.KestrelSerializer.byteListLengthEncodedSize;
import static software.amazon.smithy.java.kestrel.KestrelSerializer.uintSize;
...
public final class SparseStructureMap<T extends KestrelObject> implements KestrelObject {
    ...
    private static ByteBuffer[] readKeys(KestrelDeserializer d, int n) {
    ...
    private OptionalObject<T>[] readValues(KestrelDeserializer d, int n) {

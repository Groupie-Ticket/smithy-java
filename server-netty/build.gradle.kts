...
dependencies {
    ...
    itImplementation(project(":server-protocols:rpcV2Sparrowhawk"))
    testImplementation(project(":codegen::server"))
    testImplementation(project(":codegen::sparrowhawk-smithy-interop"))
    testImplementation(project(":codegen::sparrowhawk"))
    testImplementation(project(":sparrowhawk"))
    testImplementation(project(":sparrowhawk-codec"))
